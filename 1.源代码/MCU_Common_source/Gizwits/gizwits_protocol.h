...
* @{
*/
#define PRODUCT_KEY "76e672fbdf7d4662aa18784ea0d25ce0"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "2ea2e70a7c0c48978da824031817cf0c"
...
#define humi_MAX                           100
#define humi_LEN                           1
#define tempValue_RATIO                         1
#define tempValue_ADDITION                      20
#define tempValue_MIN                           0
#define tempValue_MAX                           20
#define tempValue_LEN                           1
#define humiValue_RATIO                         5
#define humiValue_ADDITION                      30
#define humiValue_MIN                           0
#define humiValue_MAX                           8
#define humiValue_LEN                           1
#define SmogeValue_RATIO                         10
#define SmogeValue_ADDITION                      10
#define SmogeValue_MIN                           0
#define SmogeValue_MAX                           14
#define SmogeValue_LEN                           1
#define CO2Value_RATIO                         100
#define CO2Value_ADDITION                      500
#define CO2Value_MIN                           0
#define CO2Value_MAX                           15
#define CO2Value_LEN                           1
#define smoge_RATIO                         1
#define smoge_ADDITION                      0
#define smoge_MIN                           0
#define smoge_MAX                           3000
#define smoge_LEN                           2
#define CO2_RATIO                         1
...
typedef enum
{
    anti_theft_mode_VALUE0 = 0,//关
    anti_theft_mode_VALUE1 = 1,//开
    anti_theft_mode_VALUE_MAX,
} anti_theft_mode_ENUM_T;
...
typedef struct {
    ...
    uint32_t valuevalue;
    uint32_t valuemode;
    uint32_t valueanti_theft_mode;
    uint32_t valuetemp;
    uint32_t valuehumi;
    uint32_t valuetempValue;
    uint32_t valuehumiValue;
    uint32_t valueSmogeValue;
...
typedef struct {
    ...
    uint8_t flagvalue:1;
    uint8_t flagmode:1;
    uint8_t flaganti_theft_mode:1;
    uint8_t flagtemp:1;
    uint8_t flaghumi:1;
    uint8_t flagtempValue:1;
    uint8_t flaghumiValue:1;
    uint8_t flagSmogeValue:1;
...
typedef struct {
    ...
    uint8_t valuetemp;
    uint8_t valuehumi;
    uint8_t valuetempValue;
    uint8_t valuehumiValue;
    uint8_t valueSmogeValue;
    uint8_t valueCO2Value;
    uint16_t valuesmoge;
    uint16_t valueCO2;
} devStatus_t;
