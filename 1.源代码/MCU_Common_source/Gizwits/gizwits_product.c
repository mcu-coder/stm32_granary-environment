...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *gizdata, uint32_t len)
{
    ...
    for(i=0; i<info->num; i++)
    {
        ...
        case EVENT_anti_theft_mode:
            ...
            switch(currentDataPoint.valueanti_theft_mode)
            {
            case anti_theft_mode_VALUE0:
                //user handle
                break;
            case anti_theft_mode_VALUE1:
                //user handle
                break;
            default:
                break;
...
void userHandle(void)
{
 /*
    ...
    currentDataPoint.valuevalue = ;//Add Sensor Data Collection
    currentDataPoint.valuetemp = ;//Add Sensor Data Collection
    currentDataPoint.valuehumi = ;//Add Sensor Data Collection
    currentDataPoint.valuesmoge = ;//Add Sensor Data Collection
